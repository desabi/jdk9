...
/**
 * source: chatgpt. Imagine you have an interface DataProcessor that provides default methods for
 * processing data in different formats (e.g., JSON and XML). The processing logic for each format
 * might share some common steps, such as validating the data.
 */
