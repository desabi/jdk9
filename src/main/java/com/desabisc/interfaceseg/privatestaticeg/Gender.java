...
/**
 * Since the static methods of an interface can be called without creation of an implementing
 * object, these methods can only be called by public static methods defined in the interface.
 */
