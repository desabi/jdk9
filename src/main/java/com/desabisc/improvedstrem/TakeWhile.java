...
/**
 * 1. takeWhile() Real-World Example Scenario: Processing User Transactions Suppose you are
 * processing a list of user transactions and want to process only those transactions that are below
 * a certain amount, stopping when you encounter a transaction that exceeds this threshold.
 */
