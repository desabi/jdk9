...
/**
 * 2. dropWhile() Real-World Example Scenario: Filtering Sorted Transactions In a similar scenario,
 * if the transactions are sorted, you might want to skip the lower-value transactions and start
 * processing once a threshold is reached.
 */
