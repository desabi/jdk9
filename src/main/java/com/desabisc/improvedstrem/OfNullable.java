...
/**
 * 3. ofNullable() Real-World Example Scenario: Safely Processing Optional User Data In some cases,
 * you may be processing data that could be null. For instance, if you are working with
 * user-provided input, you can use ofNullable() to avoid NullPointerException when processing the
 * data.
 */
