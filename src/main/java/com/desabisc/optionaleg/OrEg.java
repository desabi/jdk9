...
/**
 * 2. or() Real-World Example: LanguagePreference Scenario: Providing a Default Value You might have
 * a scenario where you need a fallback value if the current Optional is empty. For example, when
 * fetching a user’s preferred language, you might return an alternative Optional if no preference
 * is set.
 */
public class OrEg {
