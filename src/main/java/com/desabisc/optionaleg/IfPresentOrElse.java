...
/**
 * 1. ifPresentOrElse() Real-World Example: UserLoginProcessor Scenario: Handling User Data Imagine
 * you’re processing user data, and you want to perform one action if the user is logged in (value
 * is present) and a different action if the user is not logged in (value is absent).
 */
