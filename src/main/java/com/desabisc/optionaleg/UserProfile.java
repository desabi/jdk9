...
/**
 * Combining Optional Enhancements in a Real-World Application Scenario: User Profile Processing
 * Suppose you're building an application that processes user profiles, with some optional fields
 * like a bio and social media links. You want to handle these optional fields gracefully, provide
 * defaults where necessary, and throw an exception if a required field like the username is
 * missing.
 */
